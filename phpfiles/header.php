...
<body onLoad="MM_preloadImages('images/homeover.png','images/forumover.png','images/aboutover.png','images/portfolioover.png','images/logoutover.png','images/loading.gif')">
	
<table id="main" cellpadding="0px" cellspacing="0px">
<tr><td rowspan="4" id="sideleft"></td><td id="title"><img src="images/title.png"></td><td rowspan="4" id="sideright" /></td></tr>
<tr><td height="31px" valign="middle">
